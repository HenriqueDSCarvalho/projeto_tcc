    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="card text-dark bg-outline-dark o-hidden h-100">
                    <div class="card-body">
                        <div class="card-body-icon">
                            <i class="fas fa-alto fa-fw fa-"></i>
                        </div>
                        <div>Estoque Alto:<strong><?php echo " " . $row_excesso; ?></strong></div>
                        <p style="font-size:70%;">Produtos com quantidade superior a : 80 unidades</p>
                    </div>
            ...
            <div class="card text-dark bg-outline-dark o-hidden h-100">
                    <div class="card-body">
                        <div class="card-body-icon">
                            <i class="fas fa-baixo fa-fw fa-"></i>
                        </div>
                        <div>Estoque Baixo:<strong><?php echo " " . $row_abaixo; ?></strong></div>
                        <p style="font-size:70%;">Produtos com quantidade inferior a : 10 unidades. </p>
                    </div>
            ...
            <div class="card text-dark bg-outline-dark o-hidden h-100">
                    <div class="card-body">
                        <div class="card-body-icon">
                            <i class="fas fa-dinh fa-fw fa-"></i>
                        </div>
                        <div>Custo do estoque atual:</div>
